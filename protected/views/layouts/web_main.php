...
<html lang="en">
    ...
    <body>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; <a href="http://www.imamhasan.me" target="_blank" rel="noopener noreferrer">imamhasan.me</a></p></div>
        </footer>
        <!-- Bootstrap core JS-->
